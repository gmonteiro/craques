...
// Fixed looks per player id (original characters, not real people)
const OVR: Record<string, Partial<{ skin: [string, string]; hair: string; style: HairStyle; beard: boolean; band: string }>> = {
  ...
  neymar:    { skin: SKINS[3], hair: '#0c0c0c', style: 'curly', beard: false },
  ...
  saka:      { skin: SKINS[5], hair: '#0c0c0c', style: 'short', beard: false },
  virgil:    { skin: SKINS[5], hair: '#0c0c0c', style: 'buzz', beard: true },
  yamal:     { skin: SKINS[2], hair: '#1d150e', style: 'curly', beard: false },
  ...
  raphinha:  { skin: SKINS[4], hair: '#0c0c0c', style: 'curly', beard: false },
  marquinhos:{ skin: SKINS[4], hair: '#0c0c0c', style: 'curly', beard: false },
  ...
  gavi:      { skin: SKINS[2], hair: '#1d150e', style: 'volume', beard: false },
  ...
  romario:   { skin: SKINS[4], hair: '#0c0c0c', style: 'short', beard: false },
